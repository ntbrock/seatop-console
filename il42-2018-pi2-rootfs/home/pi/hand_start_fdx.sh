...
$BASEDIR/set_unix_time_from_gps.py $GPS_USB
...
### 2015-Mar-28 invoke nx2 mode vi abinary signal

#$BASEDIR/cat_nmea_usb.py ${NX2_USB} >> $DATEDIR/nmea_USB${NX2_USB}-nx2.txt & 
$BASEDIR/go_FDX_usb.py $NX2_USB 4800

sleep 2

$BASEDIR/cat_FDX_usb.py ${NX2_USB} 19200 >> $DATEDIR/nmea_USB${NX2_USB}-nx2.bin & 
...
ln -s $DATEDIR/nmea_USB${NX2_USB}-nx2.txt ${HOME}/nmea_USB${NX2_USB}-nx2.bin
